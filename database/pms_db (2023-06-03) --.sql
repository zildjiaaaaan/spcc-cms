...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 03, 2023 at 11:21 AM
...
(1, 'Stethoscope', 'Littmann', '2022-01-05', 15, 0),
...
(6, 'Oxygen Concentrator', 'Philips', '2022-06-30', 50, 0),
(7, 'Pulse Oximeter', 'Nonin', '2022-07-05', 50, 0),
...
(12, 'Exam Table', 'Midmark', '2022-12-30', NULL, 0),
(13, 'Surgical Instrument Set', 'Stryker', '2023-01-05', 0, 0),
(14, 'Operating Microscope', 'Leica', '2023-02-10', 51, 0),
(15, 'Dental Chair', 'A-dec', '2023-03-15', 2, 0),
(16, 'Disposable Syringe', 'Indoplas', '2023-05-26', 20, 0),
(17, 'Weighing Scale', '', '2023-05-01', NULL, 0);
...
(1, 2, 'Unavailable', 'Borrowed', '2023-06-02', '2023-06-03', 1, 'test1', 0),
(2, 2, 'Unavailable', 'Borrowed', '2023-06-02', '2023-06-10', 1, 'test 1 (naubos)', 0),
...
(6, 13, 'Unavailable', 'Borrowed', '2023-06-02', '2023-06-05', 3, 'test2.2', 0),
(7, 1, 'Unavailable', 'Borrowed', '2023-06-02', '2023-06-03', 60, 'In section 401 A', 0),
(8, 2, 'Available', 'Non-Borrowable', NULL, NULL, 3, '', 0),
(9, 3, 'Unavailable', 'Missing', '2023-05-26', NULL, 10, 'Last seen at Room 103', 0),
(10, 16, 'Unavailable', 'Borrowed', '2023-06-02', '2023-06-10', 10, 'test1 (no leftover)', 0),
(11, 1, 'Available', 'Active', NULL, NULL, 0, '', 0),
(12, 13, 'Unavailable', 'Borrowed', '2023-06-02', '2023-06-03', 1, 'test2', 0),
(13, 16, 'Unavailable', 'Borrowed', '2023-06-02', '2023-06-03', 10, 'test2.3', 0),
(14, 14, 'Available', 'Active', NULL, NULL, 30, 'For program', 0),
(15, 6, 'Available', 'Active', NULL, NULL, 50, 'For program', 0),
(16, 7, 'Available', 'Active', NULL, NULL, 40, 'For program', 0),
(17, 14, 'Unavailable', 'Borrowed', '2023-06-02', '2023-06-10', 20, 'test 2 (may natira)', 0),
(18, 9, 'Unavailable', 'Borrowed', '2023-06-02', '2023-06-10', 20, 'testing', 0),
(19, 7, 'Unavailable', 'Borrowed', '2023-06-02', '2023-06-10', 10, 'test2 (with leftover)', 0);
...
(9, 'Adderall', 'RiteMed', 0),
(12, 'Amoxicillin', 'Brand X', 0),
(14, 'Lisinopril', 'Generics', 0),
(15, 'Metformin', 'Merck', 0),
(16, 'Omeprazole', 'AstraZeneca', 0),
(17, 'Paracetamol', 'Johnson & Johnson', 0),
(18, 'Amoxicillin', 'Pfizer', 0),
(19, 'Ciprofloxacin', 'Bayer', 0),
(20, 'Simvastatin', 'Novartis', 0),
(21, 'Ibuprofen', 'GSK', 0),
(22, 'Metoprolol', 'Sanofi', 0),
(23, 'Prednisone', 'AbbVie', 0),
(24, 'Amlodipine', 'Teva', 0),
(25, 'Losartan', 'Sandoz', 0),
(26, 'Diazepam', 'Roche', 0),
(27, 'Albuterol', 'Mylan', 0),
(28, 'Levothyroxine', 'Mylan', 0),
(29, 'Fluoxetine', 'Eli Lilly', 0),
(30, 'Escitalopram', 'Forest Laboratories', 0),
(31, 'Sertraline', 'Pfizer', 0),
(32, 'Hydrochlorothiazide', 'Teva', 0),
(33, 'Metoprolol', 'Xyzal', 0);
...
(1, 4, 'Syrup', '2023-06-05', 19, NULL, 0),
(2, 4, 'Syrup', '2023-05-26', 30, NULL, 0),
(3, 5, 'Gel', '2024-07-13', 12, NULL, 0),
(4, 6, 'Tablet', '2024-05-19', 0, NULL, 0),
(5, 3, 'Tablet', '2024-05-20', 0, NULL, 0),
(6, 2, 'Capsule', '2023-12-14', 53, NULL, 0),
(7, 7, 'Spray', '2023-10-14', 33, NULL, 0),
(8, 8, 'Capsule', '2023-06-18', 5, NULL, 0),
(9, 8, 'Tablet', '2024-03-14', 0, NULL, 0),
(10, 2, 'Tablet', '2023-09-01', 50, NULL, 0),
(11, 7, 'Capsule', '2023-12-31', 300, NULL, 0);
...
(1, 'DELACRUZ, JUAN, SALVADOR', 'Sample Address 101 - Updated', '123654722', '1999-06-23', '091235649879', 'Male', 'Test', 'Test', '789456', 1),
...
INSERT INTO `patient_visits` (`id`, `visit_date`, `next_visit_date`, `bp`, `weight`, `disease`, `pres_remarks`, `patient_id`, `user_id`) VALUES
(1, '2022-06-28', '2022-06-30', '120/80', '65 kg.', 'Wounded Arm', 'No Remarks', 1, 1),
(2, '2022-06-30', '2022-07-02', '120/80', '65 kg.', 'Rhinovirus', 'No Remarks', 1, 1),
(4, '2023-05-18', '2023-05-23', '120/80', '50 kg', 'Flu', 'No Remarks', 1, 4),
(6, '2023-05-18', '2023-05-19', '120/80', '50 kg', 'Toothache', 'No Remarks', 5, 1),
(7, '2023-05-19', '2023-05-21', '120/70', '65 kg', 'Fever', 'This is a test', 6, 4),
(8, '2023-05-20', '2023-05-22', '123', '123', 'test', 'test', 6, 1),
(9, '2023-05-27', '2023-05-29', '125/85', '55', 'Headache', 'Take this medicine 3x a day', 8, 1);
...
(4, 'Zildjian', 'zildjian-admin', '81dc9bdb52d04dc20036dbd8313ed055', '1684405733Darth-Vader-Dark-Minimal-iPhone-Wallpaper.png', 'Staff');
