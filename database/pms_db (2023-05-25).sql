...
--
-- Host: 127.0.0.1
-- Generation Time: May 25, 2023 at 12:52 PM
...
CREATE TABLE `borrowed` (
  ...
  `equipment_details_id` int(11) DEFAULT NULL
...
(1, 'John', 'Doe', 'Smith', 'Manager', 'B001', '1234567890', 0),
(2, 'Jane', 'Lee', 'Johnson', 'Supervisor', 'B005', '9876543210', 0),
(3, 'Zildjian', 'Sanchez', 'Magante', 'Student Assistant', 'B003', '09991234567', 0);
...
(1, 'Equipment 1', 'Brand X', '2023-03-29', 15, 0),
(2, 'Equipment 2', 'Brand Y', '2023-05-12', 20, 0),
(3, 'Equipment 3', 'Brand Z', '2023-05-10', 10, 0),
(4, 'Disposable Syringe', 'Indoplas', '2023-05-05', 50, 0),
(6, 'Microscope', 'Brand Z', '2023-05-01', 5, 0);
...
(1, 4, 'Available', 'Active', NULL, NULL, 25, 'Supplier Contact: 0912345678', 0),
(2, 1, 'Unavailable', 'Defective', '2023-05-21', NULL, 15, 'Need to be repaired', 0),
(6, 4, 'Available', 'Active', NULL, NULL, 5, 'this is a test', 0),
(7, 6, 'Unavailable', 'Borrowed', '2023-05-24', '2023-05-25', 1, 'BSIT 302 B', 0),
(8, 4, 'Available', 'Non-Borrowable', NULL, NULL, 5, '', 0),
(9, 3, 'Unavailable', 'Used', '2023-05-24', NULL, 5, 'for disposal', 0),
(10, 4, 'Available', 'Active', '0000-00-00', '0000-00-00', 5, 'for health program', 0),
(11, 4, 'Available', 'Non-Borrowable', '0000-00-00', '0000-00-00', 5, 'for ojt', 0);
...
(1, 4, 'Syrup', '2023-08-05', 20, 0),
(2, 4, 'Syrup', '2023-07-12', 30, 0),
(3, 5, 'Gel', '2024-07-13', 12, 0),
(4, 6, 'Tablet', '2024-05-19', 0, 0),
(5, 3, 'Tablet', '2024-05-20', 0, 0),
(6, 2, 'Capsule', '2023-12-14', 55, 0),
(7, 7, 'Spray', '2023-10-14', 33, 0),
(8, 8, 'Capsule', '2023-08-18', 5, 0),
(9, 8, 'Tablet', '2024-03-14', 0, 1),
(10, 2, 'Tablet', '2023-09-01', 50, 1);
